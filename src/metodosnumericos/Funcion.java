...
public class Funcion {
    ...
    public Double Evaluar(double x) throws ParseException{
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Función Ingresada Incorrecta", "ERROR", 0);
        }
    ...
    public int menu(){
        String m = JOptionPane.showInputDialog("Elija la forma de paro que desee:\n1.- Iteraciones"
                + "\n2.- Tolerancia\nSeleccione una Opción:");
        while (!isNum(m) && (Integer.parseInt(m) != 1 || Integer.parseInt(m) != 2)){
            JOptionPane.showMessageDialog(null, "Opción Incorrecta!", "ERROR", 0);
            m = JOptionPane.showInputDialog("Elija la forma de paro que desee:\n1.- Iteraciones"
                + "\n2.- Tolerancia\nSeleccione una Opción:");
        }
        return Integer.parseInt(m);
    }
